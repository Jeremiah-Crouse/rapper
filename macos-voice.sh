...
pip install -q "transformers<4.46" "torch<2.6" 2>&1 | tail -1
pip install -q TTS flask flask-cors --no-deps 2>&1 | tail -1
pip install -q scipy torchaudio librosa einops 2>&1 | tail -1
